...
const BlockedVendorModal = ({blockVendorName, setBlockVendor, setVendorBlocked}) => {
        ...
        <>
            ...
            <div className="min-w-[500px] flex flex-col items-center p-[20px] fixed z-1000 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#FFFFFF] rounded-[10px] shadow-xl">
                ...
                <div className='flex flex-col items-center mt-[10px]'>
                    <p className='text-[26px] text-[#4B465C] text-center'>Blocked Vendor {blockVendorName}!</p>
                </div>
                <div className='flex justify-center items-center space-x-3 mt-[15px]'>
                    <button onClick={() => setVendorBlocked(false)} className='bg-[#DC7A39] text-white px-[15px] py-[5px] rounded-[5px] text-center'>Done</button>
                </div>
            </div>
...
export default BlockedVendorModal;