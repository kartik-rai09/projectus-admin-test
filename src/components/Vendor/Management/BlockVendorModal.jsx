...
const BlockVendorModal = ({blockVendorName, setBlockVendor, setVendorBlocked}) => {
        ...
        <>
            ...
            <div className="min-w-[500px] flex flex-col items-center p-[20px] fixed z-1000 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#FFFFFF] rounded-[10px] shadow-xl">
                ...
                <div className='flex flex-col items-center mt-[10px]'>
                    <p className='text-[26px] text-[#4B465C] text-center'>Block Vendor {blockVendorName}?</p>
                    <p className='text-[#4B465C] text-[14px] text-center'>This will block the vendor</p>
                </div>
                <div className='flex justify-center items-center space-x-3 mt-[15px]'>
                    <button onClick={() => {
                        setBlockVendor(false)
                        setVendorBlocked(true)
                    }} className='bg-[#DC7A39] text-white px-[15px] py-[5px] rounded-[5px] text-center'>Confirm</button>
                    <button onClick={() => setBlockVendor(false)} className='px-[15px] py-[5px] text-center rounded-[5px] border-[1px] border-[#2A4F6D]'>Cancel</button>
                </div>
            </div>
