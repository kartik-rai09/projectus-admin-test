        ...
        <div className=" mt-[20px]">
            <form>
                ...
                <div className="flex w-full justify-center items-center mt-[30px] space-x-5">
                    <div onClick={() => setEditVendor(false)} className="bg-[#3C3836] text-white text-center rounded-[5px] px-[20px] py-[3px] cursor-pointer">Save</div>
                    <div onClick={() => setEditVendor(false)} className="bg-[#A8AAAE29] text-[#3C3836] text-white text-center rounded-[5px] px-[20px] py-[3px] cursor-pointer">Cancel</div>
                </div>
            </form>
        </div>
        </>
