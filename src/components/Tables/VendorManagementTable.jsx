...
const VendorManagementTable = ({DataList, setViewVendor, setEditVendor, setBlockVendor, setBlockVendorName, setVendorDetails}) => {
                    ...
                    return (
                        <tr className="bg-white py-[10px]">
                            ...
                            <td className="bg-white flex items-center space-x-3">
                                ...
                                }} src="/Images/RemoveIcon.png" alt="icon" className="w-[20px]" />
                            </td>
                        </tr>)
                    })
                }
