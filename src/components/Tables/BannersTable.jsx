...
const BannersTable = ({DataList, setViewBanner, setEditBanner, setDeleteBanner, setDeleteBannerName, setBannerDetails}) => {
        ...
        <table id="myTable" class="display">
            <thead>
                <tr>
                    ...
                    <th className="text-[#656565] text-[18px]">CTA LINK</th>
